...
export const PAYPAL_AUTHORIZATION_SERVICE_INSTANCE_TOKEN =
  'paypal_authorization_service_token';
export const PAYPAL_PAYMENT_SERVICE_INSTANCE_TOKEN =
  'paypal_payment_service_token';
